  ...
  return (
    <div className="loading position-relative">
      <Container className="d-flex justify-content-between align-items-center gap-md-5 flex-column flex-md-row mt-3 mt-xl-4 overflow-hidden">
        ...
        >
          <AnimationTitles className="text-center text-md-start" title="Future of real estate investing" />
          <p className="gray-90 mt-3 fs-5 text-center text-md-start px-3 px-md-0">
          ...
          <div className="cards">
            <Card className="bg-black-100 rounded">
              <Card.Body className="p-2">
                ...
                <h5 className="mt-2 text-text-primary fw-normal">Residence Rybna</h5>
                ...
                <div className="d-flex">
                  ...
                  <div>
                    <h6 className="text-text-primary">29.71 ETH</h6>
            ...
            <Card className="bg-black-100">
              <Card.Body className="p-2">
                ...
                <h5 className="mt-2 text-text-primary fw-normal">Blue Sky</h5>
                ...
                <div className="d-flex">
                  ...
                  <div>
                    <h6 className="text-text-primary">17.31 ETH</h6>
                    <span className="gray-90">Current Bid</span>
                  </div>
                </div>
              </Card.Body>
