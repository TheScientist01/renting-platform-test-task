  ...
  return (
    <div className="subscribe">
      <Container>
        ...
        <div className="bg-black-100 d-flex justify-content-between align-items-center mx-auto p-1">
          <input
            placeholder="Enter Your Email"
            className="border-0 text-text-primary ps-1 w-100 bg-transparent"
          />
